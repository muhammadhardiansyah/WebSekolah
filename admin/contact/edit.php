        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <a href="guru.php" class="btn btn-light btn-sm"><i class="fa fa-chevron-left mr-1"></i> Kembali</a>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
if (isset($_POST['update'])){
    ...
    //update data
    $result = mysqli_query($koneksi, "UPDATE guru SET nama='$nama', id_jabatan = '$jabatan', gambar = '$gambar' WHERE id_guru = $id_guru");
    
    echo "
    <script type='text/javascript'>location.href = 'guru.php';</script>
    ";
...
//fetch user data
$query = mysqli_query($koneksi, "SELECT * FROM guru INNER JOIN jabatan ON guru.id_jabatan = jabatan.id_jabatan AND id_guru = $id_guru");
